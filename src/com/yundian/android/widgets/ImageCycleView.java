...
public class ImageCycleView extends LinearLayout {
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(R.drawable.banner_point_normal);
            for (int i = 0; i < mImageViews.length; i++) {
                if (index != i) {
                    mImageViews[i].setBackgroundResource(R.drawable.banner_point_pressed);
                }
            }
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mImageViewCacheList.isEmpty()) {
                imageView = (ImageView) LayoutInflater.from(container.getContext()).inflate(R.layout.home_page_ad_item, container,false);
